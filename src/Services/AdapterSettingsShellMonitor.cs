...
internal static class AdapterSettingsShellMonitor
{
    ...
    private static bool IsFactoryExplorer(int pid)
    {
        try
        {
            ...
            foreach (string factoryCmd in ExplorerFactoryCommandLines)
                if (cmdLine.Contains(factoryCmd, StringComparison.OrdinalIgnoreCase)) return true;
        }
        catch
        {
            // ignore
    ...
    private sealed class ProcessMonitor
    {
        ...
        public void Start()
        {
            ...
            {
                IsBackground = true,
                Name = "AdapterSettingsProcessMonitor",
            }.Start();
        }
    ...
    private sealed class MainWindowMonitor
    {
        ...
        public void Start()
        {
            ...
            {
                IsBackground = true,
                Name = "AdapterSettingsMainWindowMonitor",
            }.Start();
        }
    ...
    private sealed class WindowDestroyMonitor
    {
        ...
        public void Start()
        {
            ...
            {
                IsBackground = true,
                Name = "AdapterSettingsWindowDestroyMonitor",
            }.Start();
        }
            ...
            int idObject, int idChild, uint dwEventThread, uint dwmsEventTime)
        {
            ...
            StringBuilder className = new(256);
            if (GetClassName(hwnd, className, 256) > 0 && className.ToString() == TargetWindowClass) PostThreadMessage(_threadId, WM_QUIT, IntPtr.Zero, IntPtr.Zero);
        }
