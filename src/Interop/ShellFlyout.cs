...
internal static unsafe partial class ShellFlyout
{
    ...
    private ref struct ComHandles
    {
        ...
        public void Dispose()
        {
            ...
            if (Flyout != IntPtr.Zero) Marshal.Release(Flyout);
            if (ExperienceManager != IntPtr.Zero) Marshal.Release(ExperienceManager);
    ...
    private static bool TryAcquireFlyoutInterfaces(string experienceName, Guid experienceIID, ref ComHandles handles)
    {
        ...
        if (hr < 0 || handles.Factory == IntPtr.Zero) return false;
        ...
        GetExperienceManagerDelegate getExperienceManager =
            Marshal.GetDelegateForFunctionPointer<GetExperienceManagerDelegate>(
    ...
    private static bool ShowFlyoutCOM(string experienceName, Guid experienceIID)
    {
        ...
        try
        {
            ...
            ShowFlyoutDelegate showFlyout =
                Marshal.GetDelegateForFunctionPointer<ShowFlyoutDelegate>(flyoutVtable[VTABLE_SHOW_FLYOUT]);
            WFRect rect = default;
