...
This project was originally written in C++, but I couldn't get the glyph-sourced tray icons to render crisply. I did enjoy the 8MB total worth of RAM that app used though.. I also had this written up in WinUI 3, but packaging and distribution resulted in a ~250MB wad of junk, so I ended up with WPF.
